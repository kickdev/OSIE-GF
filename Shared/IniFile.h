...
public:
	...
	static string GetValueEx(string KeyName, string FileName);
	static int GetIntValue(string KeyName, string SectionName, string FileName);
	static int GetBoolValue(string KeyName, string SectionName, string FileName);
