...
CLog* g_Log = (CLog*)0x01509A40;

void L2GFExtL2MFix()
{
	NOPMemory(0x407B92, 5); //disable send mail to nc
	NOPMemory(0x407F6A, 5); //disable send mail to nc
}
...
void DllInitializer(HMODULE hDllModule, DWORD ul_reason_for_call)
{
	...
	if(ul_reason_for_call == DLL_PROCESS_ATTACH)
	{
		...
		{
			if(*((UINT64*)0x401000) == 0x42B1C0320424548A)
			{
